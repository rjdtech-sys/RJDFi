...
class EdgeSync {
  ...
  async findValidVendorId() {
    ...
    const local = this.loadLocalVendorId();
    if (local) {
      this.vendorId = local;
      return local;
    }
    ...
    try {
      ...
      if (licData) {
        ...
        if (effective) {
          this.vendorId = effective;
          this.saveLocalVendorId(effective);
    ...
    try {
      ...
      if (vRow && vRow.vendor_id) {
        this.vendorId = vRow.vendor_id;
        this.saveLocalVendorId(vRow.vendor_id);
    ...
    try {
      ...
      if (urRow && urRow.user_id) {
        this.vendorId = urRow.user_id;
        this.saveLocalVendorId(urRow.user_id);
    ...
    try {
      ...
      if (data) {
        ...
        if (data.vendor_id) {
          ...
          await this.supabase
            .from('vendors')
            .update({ vendor_id: this.vendorId, status: 'online' })
        ...
        if (this.vendorId) {
          newMachinePayload.vendor_id = this.vendorId;
        }
