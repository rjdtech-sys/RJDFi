 ...
 */
function isGenericUuid(uuid: string): boolean {
 ...
 */
function readDmiField(label: string, sysfsPath: string): string | null {
 ...
 */
function trySudoExec(command: string): string | null {
 ...
 */
function tryReadProductUuidElevated(): string | null {
 ...
 */
function tryDmidecodeField(field: string): string | null {
 ...
 */
function tryParseDmidecodeFull(): string | null {
  try {
 ...
 */
function buildCompositeFingerprint(): string | null {
  const parts: string[] = [];
