          ...
          <div className="p-4 space-y-4">
             <div className="grid grid-cols-3 gap-2">
                ...
                >
                  ...
                  <div className="text-[9px] text-slate-500">No GPIO</div>
                </button>
             </div>
             {isOrangePi ? (
               ...
               <div className="flex flex-col sm:flex-row gap-4">
                 <div className="flex-1 bg-slate-50 rounded-lg p-3 border border-slate-200">
                   <div className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">x64 PC — No GPIO</div>
                   <p className="text-[10px] text-slate-600">
                     No physical GPIO pins. Coin detection is handled exclusively by NodeMCU devices on your VLAN network.
                   </p>
                 </div>
                 <button
                   onClick={handleSave}
